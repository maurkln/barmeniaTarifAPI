...
app.use(cors({ origin: ["http://localhost:5173", "null", "https://pfoteplus.de"] })) // Erlaubt Zugriff vom Frontend und File index.html
...
app.post("/api/tarifierung", async (req, res) => {
  console.log("Neue Anfrage eingetroffen!")
